...
execute as @a[nbt={ActiveEffects:[{Id:8b}]},scores={jump=1..}] at @s run playsound minecraft:contact.green_jump master @a ~ ~ ~ 1 1
...
tag @a[tag=greenjump] add greenlev

effect clear @a[scores={lev=..0},tag=greenlev] minecraft:levitation

tag @a[nbt=!{ActiveEffects:[{Id:25b}]},tag=greenlev] remove greenlev
