...
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~ ~-1 ~ #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~ ~2 ~ #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~-1 ~ ~ #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~1 ~ ~ #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~ ~ ~1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~ ~ ~-1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~-1 ~1 ~ #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~1 ~1 ~ #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~ ~1 ~1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~ ~1 ~-1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
...
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~1 ~ ~-1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~-1 ~ ~-1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~1 ~1 ~1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~-1 ~1 ~1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~1 ~1 ~-1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1
execute as @a[scores={speed=..10},gamemode=!spectator] at @s if block ~-1 ~1 ~-1 #paint:speed run playsound minecraft:contact.yellow master @a ~ ~ ~ 2 1

scoreboard players set @a[nbt={ActiveEffects:[{Duration:40,Id:1b,Amplifier:2b}]}] speed 41
