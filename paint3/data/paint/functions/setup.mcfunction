tellraw @a ["",{"text":"\n\n"},{"text":"\n\n"},{"text":"\n\n"},{"text":"\n\n"},{"text":"\n\n"},{"text":"\n","color":"gray"},{"text":"Welcome back at Byron Dynamics","color":"aqua"},{"text":"\n","color":"gray"},{"text":"Want more of my Content?","color":"gold","clickEvent":{"action":"open_url","value":"https://www.reddit.com/user/AlexTestria/posts/"},"hoverEvent":{"action":"show_text","value":{"text":"","extra":[{"text":"Download my Content here!","color":"gold"}]}}}]
tellraw @a [{"text":"Creator: ","color":"gray"},{"text":"Alextestria","color":"gold"}]
tellraw @a ["",{"text":"\n","color":"gray"},{"text":"Resourcepack","color":"gold","clickEvent":{"action":"open_url","value":"https://www.dropbox.com/s/zq3vqf4r8uyyr71/BD%20RP%20-%20Alpha%20V1.3%20Full%20Edition.zip?dl=1"},"hoverEvent":{"action":"show_text","value":"Click to download the Map Resourcepack."}},{"text":" | "},{"text":"Optifine","color":"gold","clickEvent":{"action":"open_url","value":"http://optifine.net/adloadx?f=OptiFine_1.14.4_HD_U_F3.jar&x=8117"},"hoverEvent":{"action":"show_text","value":"Download Optifine. (Highly recommended)"}},{"text":" | "},{"text":"Preferred Shader","color":"gold","clickEvent":{"action":"open_url","value":"https://www.dropbox.com/s/nrfa1ag962corqd/Byron%20Dynamics%202%20Shader%20Packs.zip?dl=1"},"hoverEvent":{"action":"show_text","value":"Download the preferred Shaders for this Map!"}}]

#Functions
function paint:permissions/setup
function paint:ticks/20t
function paint:ticks/5t
function paint:ticks/2t
...
#Turrets
scoreboard objectives add raycastlength dummy
scoreboard objectives add turretx dummy
scoreboard objectives add turrety dummy
scoreboard objectives add firecd dummy
...
scoreboard objectives add shootcd dummy
...
scoreboard objectives add menu1 minecraft.dropped:minecraft.redstone_lamp
scoreboard objectives add menu2 minecraft.dropped:minecraft.redstone_block
scoreboard objectives add menu3 minecraft.dropped:minecraft.spruce_fence_gate
...
scoreboard players set maxlasers count 50
scoreboard players set maxlaser count 50
scoreboard players set cubelasers count 0
scoreboard players set lasers count 0
scoreboard players set air count 301
...
team modify cube_a color dark_aqua
team modify cube_b color green
team modify cube_c color gold
team modify cube_d color red
team modify cube_e color white
team modify cube_f color dark_purple
team modify cube_a collisionRule never
team modify cube_b collisionRule never
team modify cube_c collisionRule never
team modify cube_d collisionRule never
team modify cube_e collisionRule never
team modify cube_f collisionRule never
