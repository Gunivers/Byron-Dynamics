teleport @s ^ ^ ^0.2
execute if entity @s[tag=blue] positioned ~ ~ ~ run particle minecraft:dust 0 0.7 1 0.8 ~ ~ ~ 0.05 0.05 0.05 1 1
execute if entity @s[tag=green] positioned ~ ~ ~ run particle minecraft:dust 0 1 0.2 0.8 ~ ~ ~ 0.05 0.05 0.05 1 1
execute if entity @s[tag=yellow] positioned ~ ~ ~ run particle minecraft:dust 1 0.8 0 0.8 ~ ~ ~ 0.05 0.05 0.05 1 1
execute if entity @s[tag=red] positioned ~ ~ ~ run particle minecraft:dust 1 0 0.5 0.8 ~ ~ ~ 0.05 0.05 0.05 1 1
execute if entity @s[tag=purple] positioned ~ ~ ~ run particle minecraft:dust 0.8 0 1 0.8 ~ ~ ~ 0.05 0.05 0.05 1 1

execute if entity @s[tag=portalblue] positioned ~ ~ ~ run particle minecraft:dust 0 0.7 1 0.8 ~ ~ ~ 0.05 0.05 0.05 1 1
execute if entity @s[tag=portalorange] positioned ~ ~ ~ run particle minecraft:dust 1 0.8 0 0.8 ~ ~ ~ 0.05 0.05 0.05 1 1


execute if entity @s[tag=laser_check] positioned ~ ~ ~ run particle minecraft:dust 1 0 1 0.2 ~ ~ ~ 0.05 0.05 0.05 1 1
...
scoreboard players set @a[nbt={ActiveEffects:[{Duration:40,Id:1b,Amplifier:1b}]}] speed 41
...
execute as @e[tag=!cubelaser,tag=startnew,tag=laser,type=shulker,tag=p1laser] run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p1laser] remove current
execute as @e[tag=!cubelaser,tag=startnew,tag=laser,type=shulker,tag=p2laser] run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p2laser] remove current
execute as @e[tag=!cubelaser,tag=startnew,tag=laser,type=shulker,tag=p3laser] run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p3laser] remove current
execute as @e[tag=!cubelaser,tag=startnew,tag=laser,type=shulker,tag=p4laser] run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p4laser] remove current
...
execute if entity @s[tag=portal,scores={pspeed=0}] run scoreboard players set @s pspeed 20
