...
#Portals
execute as @a[tag=portalmode1] at @s if block ~ ~ ~ minecraft:light_weighted_pressure_plate run tag @s remove portalmode1
execute as @a[tag=portalmode2] at @s if block ~ ~ ~ minecraft:light_weighted_pressure_plate run tag @s remove portalmode2
execute as @a[tag=portalmode] at @s if block ~ ~ ~ minecraft:light_weighted_pressure_plate run scoreboard players set @s mode 0
execute as @a[tag=portalmode] at @s if block ~ ~ ~ minecraft:light_weighted_pressure_plate run tag @s remove portalmode
execute as @a at @s if block ~ ~ ~ minecraft:light_weighted_pressure_plate run replaceitem entity @s hotbar.0 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"\",\"color\":\"green\",\"italic\":false}"},HideFlags:63,Damage:0,Unbreakable:1}

execute as @a[tag=!portalmode1] at @s if block ~ ~ ~ minecraft:heavy_weighted_pressure_plate run tag @s add portalmode1
execute as @a[tag=!portalmode2] at @s if block ~ ~ ~ minecraft:heavy_weighted_pressure_plate run tag @s add portalmode2
execute as @a at @s if block ~ ~ ~ minecraft:heavy_weighted_pressure_plate run replaceitem entity @s hotbar.0 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"\",\"color\":\"green\",\"italic\":false}"},HideFlags:63,Damage:10,Unbreakable:1}
execute as @a[tag=!portalmode] at @s if block ~ ~ ~ minecraft:heavy_weighted_pressure_plate run tag @s add portalmode
execute as @a[scores={mode=..9}] at @s if block ~ ~ ~ minecraft:heavy_weighted_pressure_plate run scoreboard players set @s mode 10


execute as @a[scores={mode=1..8}] at @s if block ~ ~ ~ #paint:fizzler run playsound minecraft:entity.squid.ambient master @a ~ ~ ~ 10 1
execute as @a[scores={mode=1..8}] at @s if block ~ ~ ~ #paint:fizzler run title @s title {"text":"","color":"dark_gray"}
execute as @a[scores={mode=1..8}] at @s if block ~ ~ ~ #paint:fizzler run title @s subtitle {"text":"Fizzlered!","color":"dark_gray"}
execute as @a[scores={mode=1..8}] at @s if block ~ ~ ~ minecraft:water run title @s title {"text":"","color":"dark_gray"}
execute as @a[scores={mode=1..8}] at @s if block ~ ~ ~ minecraft:water run title @s subtitle {"text":"Washed Out!","color":"dark_gray"}
...
execute as @a at @s if block ~ ~ ~ #paint:fizzler run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p1laser] remove current
execute as @a at @s if block ~ ~ ~ #paint:fizzler run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p2laser] remove current
execute as @a at @s if block ~ ~ ~ #paint:fizzler run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p3laser] remove current
execute as @a at @s if block ~ ~ ~ #paint:fizzler run tag @e[tag=!cubelaser,type=!player,tag=laser,tag=!startnew,tag=p4laser] remove current


execute as @a[scores={mode=0..8}] at @s if block ~ ~ ~ #paint:fizzler run scoreboard players set @s mode 0
...
execute as @a[scores={mode=0..8}] at @s if block ~ ~ ~ minecraft:water run scoreboard players set @s mode 0
...
replaceitem entity @a[tag=mode5,scores={upgrade=1..60}] hotbar.0 minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"\",\"color\":\"obfuscated\"}"},HideFlags:63,Damage:6,Unbreakable:1}
