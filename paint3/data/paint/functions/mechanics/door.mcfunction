...
replaceitem entity @e[type=armor_stand,tag=door,tag=!lock,tag=!dark] armor.head minecraft:oak_door
replaceitem entity @e[type=armor_stand,tag=door,tag=!lock,tag=dark] armor.head minecraft:birch_door
replaceitem entity @e[type=armor_stand,tag=door,tag=lock,tag=!dark] armor.head minecraft:spruce_door
replaceitem entity @e[type=armor_stand,tag=door,tag=lock,tag=dark] armor.head minecraft:jungle_door
...
execute as @e[tag=door,tag=open,scores={open=6..9}] at @s unless entity @a[distance=..4,gamemode=!spectator] unless entity @e[tag=helperbot,distance=..4] run tag @s remove open
execute as @e[tag=door,tag=!open,scores={open=0..3}] at @s if entity @a[distance=..7.5,gamemode=!spectator] run tag @s add open
execute as @e[tag=door,tag=!open,scores={open=0..3}] at @s if entity @e[distance=..7.5,tag=helperbot] run tag @s add open
tag @e[type=armor_stand,tag=door,tag=lock,tag=open] remove open

execute as @e[tag=door,tag=open,scores={open=..8}] at @s if entity @e[distance=..4,tag=helperbot] run scoreboard players add @s open 1
...
execute as @e[tag=door,tag=!open,scores={open=1..}] at @s unless entity @p[distance=..7.6,gamemode=!spectator] unless entity @e[tag=helperbot,distance=..7.6] run scoreboard players remove @s open 1
